...
/*
DTH component - used to recharge dth
*/
import { PolymerElement, html } from '@polymer/polymer/polymer-element.js';
import './shared-styles.js';

class MyDth extends PolymerElement {
      ...
      <div class="form-container">
		  <div class="card">
			...
			<paper-listbox slot="dropdown-content" selected="0">
			  <template is="dom-repeat" items="{{services.dth.providers}}">
			  <paper-item>{{item}}</paper-item>
			  </template>
			</paper-listbox>
		  </paper-dropdown-menu>
		  
			<paper-input type="text" always-float-label label="Id" value="{{serviceUniqueId}}"></paper-input>
	...
	recharge() {
		...
		if (this.serviceUniqueId.trim().length < 7) {
			this.serviceUniqueIdErrorMessage = "Dth id must be atleast 7 numbers";
			return false;
		}
		// amount validation
...
window.customElements.define('my-dth', MyDth);