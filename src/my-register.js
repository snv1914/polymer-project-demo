...
/*
Register component - used to register new user and proceeds through application
*/
...
class MyRegister extends PolymerElement {
	...
	register() {
		...
		if (list.length > 0) {
			/* if user is existed, then show error message that email already in use */
			this.mainErrorMessage = 'Email is already in use. Please use another email address';
		} else {
			/* if user is not existed, then add new user */
